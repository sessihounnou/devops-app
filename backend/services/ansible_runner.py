...
def _build_inventory(host: str, ssh_user: str, ssh_port: int = 22) -> dict:
...
async def run_playbook(
    ...
    inventory = _build_inventory(host, ssh_user, ssh_port)
    ev = extra_vars or {}

    # ansible-runner is blocking — run in thread pool
